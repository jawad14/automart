    ...
    <div className="am-topbar">
      <div className="am-wrap">
        <div className="am-tb-left">
          <a href={siteConfig.phoneHref} aria-label="Call Automart">
          ...
          <span style={{ opacity: 0.82 }}>{siteConfig.hours}</span>
        </div>
        <div className="am-tb-right">
          <span className="am-flag">★ 25 years supplying collision parts</span>
          <span className="am-sep" />
          <span style={{ opacity: 0.82 }}>Twice-daily local delivery</span>
          <span className="am-sep" />
